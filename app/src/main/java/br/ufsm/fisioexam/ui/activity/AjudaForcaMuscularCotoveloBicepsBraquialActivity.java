...
public class AjudaForcaMuscularCotoveloBicepsBraquialActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_forca_muscular_cotovelo_biceps_braquial);
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView videoA = findViewById(R.id.activity_ajuda_forca_muscular_cotovelo_biceps_braquial_video_a);
        StyledPlayerView videoB = findViewById(R.id.activity_ajuda_forca_muscular_cotovelo_biceps_braquial_video_b);

        RedimensionaPlayerVideo(videoA);
        RedimensionaPlayerVideo(videoB);


        DefineExoPlayer(exoPlayerA, "asset:///videos_cotovelo/forca_muscular_biceps_braquial_a.mp4");
        videoA.setPlayer(exoPlayerA);


        DefineExoPlayer(exoPlayerB, "asset:///videos_cotovelo/forca_muscular_biceps_braquial_b.mp4");
    ...
    private void inicializaButtons() {
        Button sair = findViewById(R.id.activity_ajuda_forca_muscular_cotovelo_biceps_braquial_button_sair);
