...
public class AjudaAmplitudeMovimentoCotoveloExtensaoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ajuda_amplitude_movimento_cotovelo_extensao);
        inicializaButtons();
        rodaVideoEmLoop();
    }

    private void rodaVideoEmLoop() {
        StyledPlayerView video = findViewById(R.id.activity_ajuda_amplitude_movimento_cotovelo_extensao_video);
        ...
        Uri videoUri = Uri.parse("asset:///videos_cotovelo/amplitude_movimento_extensao.mp4");
    ...
    private void inicializaButtons() {
        Button sair;
        sair = findViewById(R.id.activity_ajuda_amplitude_movimento_cotovelo_extensao_button_sair);
