...
public class SecaoDiagnosticoFisioterapeuticoActivity extends AppCompatActivity {


    private EditText campoDiagnosticoFisioterapeutico;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secao_diagnostico_fisioterapeutico);
        inicializaDaos();
        carregaExame();
    ...
    private void inicializaBotoes() {
        proximo = findViewById(R.id.activity_secao_diagnostico_fisioterapeutico_button_proximo);
        salvarESair = findViewById(R.id.activity_secao_diagnostico_fisioterapeutico_button_salvar_e_sair);
    ...
    private void inicializaFormulario() {
        campoDiagnosticoFisioterapeutico = findViewById(R.id.activity_secao_diagnostico_fisioterapeutico_edit_text);
        if (secoes.isDiagnosticoFisio()) {
            campoDiagnosticoFisioterapeutico.setText(exame.getDiagnosticoFisioterapeutico());
        }
    }
}
