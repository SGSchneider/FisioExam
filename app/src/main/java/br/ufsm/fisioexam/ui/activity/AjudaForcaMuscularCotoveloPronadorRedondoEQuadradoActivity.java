...
public class AjudaForcaMuscularCotoveloPronadorRedondoEQuadradoActivity extends AppCompatActivity {
    ...
    private void rodaVideoEmLoop() {
        ...
        DefineExoPlayer(exoPlayerA, "asset:///videos_cotovelo/forca_muscular_pronador_redondo_e_quadrado_a.mp4");
        videoA.setPlayer(exoPlayerA);


        DefineExoPlayer(exoPlayerB, "asset:///videos_cotovelo/forca_muscular_pronador_redondo_e_quadrado_b.mp4");
