...
public class AjudaAmplitudeMovimentoOmbroRotacaoMedialActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_amplitude_movimento_ombro_rotacao_medial);
        inicializaButtons();
        rodaVideoEmLoop();
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView video = findViewById(R.id.activity_ajuda_amplitude_movimento_ombro_rotacao_medial_video);

        RedimensionaPlayerVideo(video);

        exoPlayer = new ExoPlayer.Builder(this).build();

        Uri videoUri = Uri.parse("asset:///videos_ombro/amplitude_movimento_rotacao_medial.mp4");
    ...
    private void inicializaButtons() {
        Button sair = findViewById(R.id.activity_ajuda_amplitude_movimento_ombro_rotacao_medial_button_sair);
