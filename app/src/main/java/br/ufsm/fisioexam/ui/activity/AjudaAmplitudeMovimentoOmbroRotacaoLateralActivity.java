...
public class AjudaAmplitudeMovimentoOmbroRotacaoLateralActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_amplitude_movimento_ombro_rotacao_lateral);
        inicializaButtons();
        rodaVideoEmLoop();
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView video = findViewById(R.id.activity_ajuda_amplitude_movimento_ombro_rotacao_lateral_video);

        RedimensionaPlayerVideo(video);

        exoPlayer = new ExoPlayer.Builder(this).build();

        Uri videoUri = Uri.parse("asset:///videos_ombro/amplitude_movimento_rotacao_lateral.mp4");
    ...
    private void inicializaButtons() {
        Button sair = findViewById(R.id.activity_ajuda_amplitude_movimento_ombro_rotacao_lateral_button_sair);
