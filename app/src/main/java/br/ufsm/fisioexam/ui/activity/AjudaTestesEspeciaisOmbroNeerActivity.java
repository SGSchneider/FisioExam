...
public class AjudaTestesEspeciaisOmbroNeerActivity extends AppCompatActivity {
    private ExoPlayer exoPlayer;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ajuda_testes_especiais_ombro_neer);
        inicializaButtons();
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView video = findViewById(R.id.activity_ajuda_testes_especiais_ombro_neer_video);
        ...
        Uri videoUri = Uri.parse("asset:///videos_ombro/testes_especiais_neer.mp4");
    ...
    private void inicializaButtons() {
        Button sair = findViewById(R.id.activity_ajuda_testes_especiais_ombro_neer_button_sair);
