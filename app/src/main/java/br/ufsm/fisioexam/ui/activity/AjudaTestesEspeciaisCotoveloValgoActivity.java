...
public class AjudaTestesEspeciaisCotoveloValgoActivity extends AppCompatActivity {
    private ExoPlayer exoPlayer;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ajuda_testes_especiais_cotovelo_valgo);
        inicializaButtons();
        rodaVideoEmLoop();
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView video = findViewById(R.id.activity_ajuda_testes_especiais_cotovelo_valgo_video);
        ...
        Uri videoUri = Uri.parse("asset:///videos_cotovelo/testes_especiais_valgo.mp4");
    ...
    private void inicializaButtons() {
        Button sair = findViewById(R.id.activity_ajuda_testes_especiais_cotovelo_valgo_button_sair);
