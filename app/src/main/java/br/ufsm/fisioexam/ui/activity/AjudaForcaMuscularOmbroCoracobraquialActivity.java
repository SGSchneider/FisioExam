...
public class AjudaForcaMuscularOmbroCoracobraquialActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajuda_forca_muscular_ombro_coracobraquial);
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView videoA = findViewById(R.id.activity_ajuda_forca_muscular_ombro_coracobraquial_video_a);
        StyledPlayerView videoB = findViewById(R.id.activity_ajuda_forca_muscular_ombro_coracobraquial_video_b);

        RedimensionaPlayerVideo(videoA);
        RedimensionaPlayerVideo(videoB);


        DefineExoPlayer(exoPlayerA, "asset:///videos_ombro/forca_muscular_coracobraquial_a.mp4");
        videoA.setPlayer(exoPlayerA);


        DefineExoPlayer(exoPlayerB, "asset:///videos_ombro/forca_muscular_coracobraquial_b.mp4");
    ...
    private void inicializaButtons() {
        Button sair = findViewById(R.id.activity_ajuda_forca_muscular_ombro_coracobraquial_button_sair);
