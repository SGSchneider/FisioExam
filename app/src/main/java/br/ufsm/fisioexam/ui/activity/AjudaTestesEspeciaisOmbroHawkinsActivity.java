...
public class AjudaTestesEspeciaisOmbroHawkinsActivity extends AppCompatActivity {
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView video = findViewById(R.id.activity_ajuda_testes_especiais_ombro_hawkins_video);
        ...
        Uri videoUri = Uri.parse("asset:///videos_ombro/testes_especiais_hawkins.mp4");
    ...
    private void inicializaButtons() {
        Button sair = findViewById(R.id.activity_ajuda_testes_especiais_ombro_hawkins_button_sair);
