...
public class AjudaPronacaoAmplitudeMovimentoCotoveloActivity extends AppCompatActivity {
    ...
    private void rodaVideoEmLoop() {
        StyledPlayerView video = findViewById(R.id.activity_ajuda_amplitude_movimento_cotovelo_pronacao_video);
        ...
        Uri videoUri = Uri.parse("asset:///videos_cotovelo/amplitude_movimento_pronacao.mp4");
